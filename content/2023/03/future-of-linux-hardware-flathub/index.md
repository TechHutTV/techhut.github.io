...
![Promotional website from HP about the HP Dev One, saying "We have sold out all HP Dev One PCs and our dedicated support team is still available to assist you for 3-years from purchase. To contact support, please sign into your HP account and submit a ticket".](images/image-2.png)

<figcaption>

HP Dev One website, explaining it's discontinued.
...
![On the left we have the old Flathub logo, represented by three black and white cubes in a "L" shape, and on the right there's the new logo represented by a circle, a triangle, a square and a plus sign in a 2x2 grid.](images/image-3.png)

<figcaption>

Comparison between the old and new Flathub logos.
...
![Screenshot of Windows 11 with the text "System requirements not met. Go to settings to learn more" on the bottom right.](images/image.png)

<figcaption>

Example screenshot of the new watermark.
...
![A stylized chess clock logo, with "GNOME circle" on the bottom-right.](images/image-4.png)

<figcaption>

Logo for the latest GNOME Circle application, Chess Clock.
...
![KDE Welcome application, with the header area only containing the text "Welcome to KDE Plasma!" and the footer having "Skip" and "Next" buttons, along with dots to represent the number of pages.](images/bitmap.png)

<figcaption>

New look for the Welcome application.
